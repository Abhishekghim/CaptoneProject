...
import type { ReferringDoctorRequest } from "@/lib/types";
...
// that has no relationship to this admin's session, and approving it has to
  ...
  return (
    <section id="doctor-requests" className="card p-5 sm:p-6">
      <SectionTitle
        ...
        subtitle="External doctors request access here — internal staff accounts are still created directly by an admin"
      />
