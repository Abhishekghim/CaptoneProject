...
export interface Appointment {
  ...
  // referral document is the actual proof (see backend/database/005_referral_review_and_free_text_doctor.sql).
...
// Referring-doctor request-then-approve queue (backend/database/004_referring_doctor_requests.sql).
// Unlike everything else in this file, this is read straight from Supabase
// (see frontend/components/admin/DoctorRequestsPanel.tsx) rather than the mock store —
